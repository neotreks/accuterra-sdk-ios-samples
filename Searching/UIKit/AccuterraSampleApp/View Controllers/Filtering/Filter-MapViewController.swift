//
//  Filter-toListViewController.swift
//  AccuterraSampleApp
//
...
class Filter_MapViewController: BaseViewController {
    ...
    @IBOutlet weak var mapCenterSegController: UISegmentedControl!
    ...
    let tellurideLocation = MapLocation(latitude: 37.9375, longitude: -107.8123)
    let aspenLocation = MapLocation(latitude: 39.1911, longitude: -106.8175)
    ...
    private var mapCenter:MapLocation {
        get {
            return mapCenterSegController.selectedSegmentIndex == 0 ? tellurideLocation: aspenLocation
        }
    }
    ...
    @IBAction func mapCenterValueChanged() {
        self.trailsFilter.mapCenter = mapCenter
    }
    ...
    func searchTrails() {
        ...
        do {
            ...
            let searchCriteria = TrailMapSearchCriteria(
                mapCenter: trailsFilter.mapCenter ?? tellurideLocation,
...
extension Filter_MapViewController: UITableViewDelegate, UITableViewDataSource {
